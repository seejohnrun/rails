...
module ActiveRecord
  module ConnectionHandling
    ...
    def establish_connection(config_or_env = nil)
      ...
      connection_handler.establish_connection(db_config, owner: owner_name, role: current_role_key, shard: current_shard_key)
    end
    ...
    def connection_pool
      connection_handler.retrieve_connection_pool(connection_specification_name, role: current_role_key, shard: current_shard_key) || raise(ConnectionNotEstablished)
    end

    def retrieve_connection
      connection_handler.retrieve_connection(connection_specification_name, role: current_role_key, shard: current_shard_key)
    end

    # Returns +true+ if Active Record is connected.
    def connected?
      connection_handler.connected?(connection_specification_name, role: current_role_key, shard: current_shard_key)
    end
    ...
    def remove_connection(name = nil)
      ...
      # pool.
      if connection_handler.retrieve_connection_pool(name, role: current_role_key, shard: current_shard_key)
        self.connection_specification_name = nil
      end

      connection_handler.remove_connection_pool(name, role: current_role_key, shard: current_shard_key)
    end

...
module ActiveRecord
  ...
  module ConnectionAdapters
    ...
    class ConnectionHandler
      ...
      def establish_connection(config, owner: Base.name, role: Base.default_role_key, shard: Base.default_shard_key)
      ...
      def retrieve_connection(spec_name, role: ActiveRecord::Base.default_role_key, shard: ActiveRecord::Base.default_shard_key) # :nodoc:
        pool = retrieve_connection_pool(spec_name, role: role, shard: shard)

        unless pool
          if shard != ActiveRecord::Base.default_shard_key
      ...
      # already been opened.
      def connected?(spec_name, role: Base.default_role_key, shard: Base.default_shard_key)
        pool = retrieve_connection_pool(spec_name, role: role, shard: shard)
        pool && pool.connected?
      end
      ...
      def remove_connection(owner, role: Base.default_role_key, shard: Base.default_shard_key)

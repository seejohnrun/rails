    ...
    private
      ...
      def setup_shared_connection_pool
        ...
        handler.connection_pool_names.each do |name|
          ...
          writing_pool_config = pool_manager.get_pool_config(ActiveRecord::Base.writing_role, ActiveRecord::Base.default_shard_key)
          pool_manager.role_names.each do |role|
            pool_manager.set_pool_config(role, ActiveRecord::Base.default_shard_key, writing_pool_config)
          end
        end
      end

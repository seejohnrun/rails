    ...
    class LegacyConnectionHandlersMultiDbTest < ActiveRecord::TestCase
      ...
      unless in_memory_db?
        ...
        def test_connects_to_returns_array_of_established_connections
          ...
          assert_equal(
            [
              assert_deprecated { ActiveRecord::Base.connection_handlers[:writing].retrieve_connection_pool("ActiveRecord::Base") },
              assert_deprecated { ActiveRecord::Base.connection_handlers[:reading].retrieve_connection_pool("ActiveRecord::Base") }
            ],
            result
          )
        ensure
      ...
      def test_connection_handlers_are_per_thread_and_not_per_fiber
        ...
        reading_handler = assert_deprecated { ActiveRecord::Base.connection_handlers[:reading] }

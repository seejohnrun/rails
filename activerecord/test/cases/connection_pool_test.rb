  ...
  module ConnectionAdapters
    class ConnectionPoolTest < ActiveRecord::TestCase
      ...
      def test_idle_timeout_configuration
        ...
        spec.config_whitelisted.merge!("idle_timeout" => "0.02")
      ...
      def test_disable_flush
        @pool.disconnect!
        spec = ActiveRecord::Base.connection_pool.spec
        spec.config_whitelisted.merge!("idle_timeout" => -5)
        @pool = ConnectionPool.new(spec)
        idle_conn = @pool.checkout
        @pool.checkin(idle_conn)
      ...
      private
        def with_single_connection_pool
          ...
          one_conn_spec.config_whitelisted["pool"] = 1 # this is safe to do, because .dupped ConnectionSpecification also auto-dups its config
